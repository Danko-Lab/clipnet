...
```bash
conda create -n clipnet python=3.9 cudatoolkit~=11.8 cudnn~=8.9 cupti~=11.8 conda-forge::gcc bioconda::cyushuffle # or mamba
...
```bash
conda create -n shap python=3.9 cudatoolkit~=11.8 cudnn~=8.9 cupti~=11.8 # or mamba
conda activate shap
